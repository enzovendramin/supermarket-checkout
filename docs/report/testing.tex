...
methods of each class, excluding trivial getters and setters. The project
statement supplies no JUnit tests of its own --- only the format of the
command-line test scenarios --- so every test class in the suite was written
specifically for this project. It is organised as
...
(\code{PaymentFlowTest},
\code{Transaction}\allowbreak\code{Authorisation}\allowbreak\code{System}\allowbreak\code{Test}), the
